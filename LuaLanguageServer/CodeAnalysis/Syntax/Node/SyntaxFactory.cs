    ...
    public static LuaSyntaxNodeOrToken CreateSyntax(GreenNode greenNode, LuaSyntaxTree tree, LuaSyntaxNode? parent)
    {
        if (greenNode.IsSyntaxNode)
        {
            return new LuaSyntaxNodeOrToken(greenNode.SyntaxKind switch
            {
                ...
                LuaSyntaxKind.Comment => new Comment(greenNode, tree, parent),
                LuaSyntaxKind.DocClass => expr,
                LuaSyntaxKind.DocEnum => expr,
                LuaSyntaxKind.DocInterface => expr,
                LuaSyntaxKind.DocAlias => expr,
                LuaSyntaxKind.DocField => expr,
                LuaSyntaxKind.DocEnumField => expr,
                LuaSyntaxKind.DocType => expr,
                LuaSyntaxKind.DocParam => expr,
                LuaSyntaxKind.DocReturn => expr,
